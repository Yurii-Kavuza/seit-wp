...
<?php the_field('main_phone_number_show', 2); ?></span>
		...
		<div class="backdrop is-hidden" data-modal>
			<div class="modal">
				...
				<div name="callback" class="modal__callback" autocomplete="off">
					<?php echo do_shortcode('[contact-form-7 id="0417988" title="Запит інформації"]'); ?>
				</div>
				
				<!-- <form action="#" name="callback" class="modal__callback" autocomplete="off">
